                  ...
                  <tr>
                    <td style="padding: 0 0 36px 0; color: #153643">
                      ...
                      <p
                        ...
                        "
                      >
                        This is code <strong style='color:red;'>${shortCode}</strong>, 
                        </p>
                        <p>copy paste it at the forgot password page.</p>
                      <p
                        style="
                          margin: 0;
                          font-size: 16px;
                  ...
                  <tbody><tr>
                    <td align="center" valign="top" style="padding:40px 0px 50px 0px">
                      ...
                      <td align="center" valign="top" style="text-align:center;vertical-align:middle;background-color:#000000;height:50px">
                        ...
                        <a href="${
                          process.env.URL
                        }/user/course/${slug}" style="background-color:#000000;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:28px;padding:12px 26px;text-align:center;text-decoration:none" target="_blank">Start learning</a>
                                ...
                                <td align="right" style="padding-left:30px"><table width="225" cellpadding="0" cellspacing="0" border="0" role="presentation" align="right" style="min-width:170px">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td width="56" align="left" style="font-family:'Source Sans Pro',Helvetica,Arial,sans-serif;font-size:16px;letter-spacing:0;line-height:20px;text-align:left">RM${
                                          total / 100
                                        }</td>
                                      </tr>
                                    </tbody>
                    ...
                    <td colspan="3" style="border-top:1px solid #0d0d0d;padding-bottom:30px;padding-top:15px" align="right"><table width="160" cellpadding="0" cellspacing="0" border="0" role="presentation" align="right">
                        <tbody>
                         ...
                         <tr>
                            ...
                            <td width="56" align="left" style="font-family:'Source Sans Pro',Helvetica,Arial,sans-serif;font-size:18px;letter-spacing:0;line-height:20px;text-align:left">RM${
                              total / 100
                            }</td>
                          </tr>
                        </tbody>
